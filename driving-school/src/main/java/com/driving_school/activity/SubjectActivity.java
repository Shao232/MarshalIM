...
//import com.driving_school.activity.base.BaseFragment;
//import com.driving_school.activity.base.MyBaseActivity;
//import com.driving_school.adapter.MyFragmentPagerAdapter;
//import com.driving_school.bean.QuestionsBean;
//import com.driving_school.databinding.ActivitySubjectBinding;
//import com.driving_school.db.QuestionsMetaData;
//import com.driving_school.db.QuestionsSqlBrite;
//import com.driving_school.fragments.JudgeFragment;
//import com.driving_school.fragments.MultiselectFragment;
//import com.driving_school.fragments.RadioFragment;
//import com.driving_school.utils.FileUtils;
//import com.driving_school.utils.MyLog;
//import com.driving_school.utils.MyUtils;
//import com.driving_school.utils.StringUtil;
//import com.driving_school.widgets.SelectSubjectPopupWindow;
//
...
//        if (msg.what == 0x125) {
//            MyLog.i("设置为已收藏>>>>");
//            mBinding.ivCollectionSubject.setImageResource(R.drawable.collectionsed_img);
//        } else if (msg.what == 0x124) {
//            MyLog.i("设置为未收藏>>>>");
//            mBinding.ivCollectionSubject.setImageResource(R.drawable.my_collections_img);
...
//                setTitle(R.drawable.subject_manager_img, "1/" + dataList.size(), R.drawable.button_select_subject_img);
//                setViewPager(dataList);
//            }
//        }
//    }
...
//                setTitle(R.drawable.subject_manager_img, "1/" + subject1Count, R.drawable.button_select_subject_img);
//            } else if (type == 2) {
//                noWriteNum = subject4Count;
//                setTitle(R.drawable.subject_manager_img, "1/" + subject4Count, R.drawable.button_select_subject_img);
//            }
//
...
//        setTopLeftButton(R.drawable.back_img, v -> {
//            if (questionType == 1){
//                hint(1);
//            }else{
//                finish();
...
//        });
//        if (questionType == 1) {
//            setTopRightButton("", R.drawable.to_result_img, v -> {
//                hint(2);
//            });
//        }
//        setTopTitleClick(v -> {
...
////                        setTitle(R.drawable.subject_manager_img, newPostion + "/"+subject1Count, R.drawable.button_select_subject_img);
////                    }else{
////                        setTitle(R.drawable.subject_manager_img, newPostion + "/"+subject4Count, R.drawable.button_select_subject_img);
////                    }
////                } else {
////                    setTitle(R.drawable.subject_manager_img, "顺序练习 " + newPostion + "/" + dataList.size()
////                            , R.drawable.button_select_subject_img);
////                }
//            }
//
//            @Override
...
//        mBinding = ActivitySubjectBinding.inflate(getLayoutInflater());
