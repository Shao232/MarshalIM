...
//import com.driving_school.databinding.FragJudgeBinding;
...
//        mBinding = FragJudgeBinding.inflate(getLayoutInflater());
...
//        MyImageSpan myImageSpan = new MyImageSpan(getActivity(), R.drawable.judge_img);
...
//                        .error(R.drawable.defult_img).into(mBinding.ivJudgeSubject);
//            } else {
...
//        switch (myAnswer) {
//            case "正确":
//                mBinding.ivJudgeItem1.setImageResource(R.drawable.radio_fail_img);
//                mBinding.ivJudgeItem2.setImageResource(R.drawable.radio_yes_img);
//                break;
//            case "错误":
//                mBinding.ivJudgeItem2.setImageResource(R.drawable.radio_fail_img);
//                mBinding.ivJudgeItem1.setImageResource(R.drawable.radio_yes_img);
//                break;
//        }
