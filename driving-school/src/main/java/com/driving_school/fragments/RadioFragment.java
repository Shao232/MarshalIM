//package com.driving_school.fragments;
//
...
//import com.driving_school.activity.MyCollectionsActivity;
//import com.driving_school.activity.ShowBigImageActivity;
//import com.driving_school.activity.SubjectActivity;
//import com.driving_school.activity.base.BaseFragment;
//import com.driving_school.bean.QuestionsBean;
//import com.driving_school.databinding.FragRadioBinding;
//import com.driving_school.utils.StringUtil;
//import com.driving_school.widgets.MyImageSpan;
//
///**
...
//        mBinding = FragRadioBinding.inflate(getLayoutInflater());
...
//        MyImageSpan myImageSpan = new MyImageSpan(getActivity(), R.drawable.radio_img);
...
//                        .error(R.drawable.defult_img).into(mBinding.ivRadioSubject);
//            } else {
//                Glide.with(getContext()).load(bean.getUrl()).placeholder(R.drawable.defult_img)
//                        .error(R.drawable.defult_img).into(mBinding.ivRadioSubject);
//            }
//        } else {
...
//        switch (myAnswer) {
//            case "A":
//                mBinding.ivRadioItem1.setImageResource(R.drawable.radio_fail_img);
//                break;
//            case "B":
//                mBinding.ivRadioItem2.setImageResource(R.drawable.radio_fail_img);
//                break;
//            case "C":
//                mBinding.ivRadioItem3.setImageResource(R.drawable.radio_fail_img);
//                break;
//            case "D":
//                mBinding.ivRadioItem4.setImageResource(R.drawable.radio_fail_img);
//                break;
//        }
//        StringBuilder builder = new StringBuilder("答案: ");
//        switch (bean.getAnswer()) {
//            case "1":
//                mBinding.ivRadioItem1.setImageResource(R.drawable.radio_yes_img);
//                builder.append("A");
//                break;
//            case "2":
//                mBinding.ivRadioItem2.setImageResource(R.drawable.radio_yes_img);
//                builder.append("B");
//                break;
//            case "3":
//                mBinding.ivRadioItem3.setImageResource(R.drawable.radio_yes_img);
//                builder.append("C");
//                break;
//            case "4":
//                mBinding.ivRadioItem4.setImageResource(R.drawable.radio_yes_img);
//                builder.append("D");
//                break;
//        }
//        setExplain(builder);
