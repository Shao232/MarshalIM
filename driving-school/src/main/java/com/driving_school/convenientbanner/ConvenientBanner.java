//package com.driving_school.convenientbanner;
//
...
//import com.driving_school.convenientbanner.adapter.CBPageAdapter;
//import com.driving_school.convenientbanner.holder.CBViewHolderCreator;
//import com.driving_school.convenientbanner.listener.CBPageChangeListener;
//import com.driving_school.convenientbanner.listener.OnItemClickListener;
//import com.driving_school.convenientbanner.view.CBLoopViewPager;
...
//        initViewPagerScroll();
//
//        viewPager.setPageMargin((int) (Resources.getSystem().getDisplayMetrics().density * 8));
...
//                RelativeLayout.LayoutParams(MyUtils.getInstance().dp2px(getContext(),
//                18),MyUtils.getInstance().dp2px(getContext(), 18));
//        for (int count = 0; count < mDatas.size(); count++) {
//            // 翻页指示的点
//            ImageView pointView = new ImageView(getContext());
//            pointView.setPadding(MyUtils.getInstance().dp2px(getContext(),5),
//                    0, MyUtils.getInstance().dp2px(getContext(),5), 0);
...
//     * 指示器的方向
//     *
//     * @param align 三个方向：居左 （RelativeLayout.ALIGN_PARENT_LEFT），居中 （RelativeLayout.CENTER_HORIZONTAL），居右
...
//                float scaleFactor = (float) (MIN_SCALE + (1.0f - Math.abs(position)) * (MAX_SCALE - MIN_SCALE));
//                view.setScaleX(scaleFactor);
//                //每次滑动后进行微小的移动目的是为了防止在三星的某些手机上出现两边的页面为显示的情况
//                if (position > 0) {
//                    view.setTranslationX(-scaleFactor * 1);
//                } else if (position < 0) {
//                    view.setTranslationX(scaleFactor * 1);
//                }
