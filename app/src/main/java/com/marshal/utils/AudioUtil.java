...
public class AudioUtil {
     ...
     */
    public AudioUtil(@NonNull String savePath, @NonNull RecordAudioCallBack callBack) {
        this.savePath = savePath;
        this.callBack = callBack;
        createFile();//创建文件
        service = Executors.newSingleThreadExecutor();
        if (ActivityCompat.checkSelfPermission(MApplication.Companion.getInstance().getApplicationContext(),
    ...
    private void convertWavFile(final String outFileName) {
        Log.d("TAG","convertWaveFile:" + outFileName);
        service.execute(() -> {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e("TAG","convertWaveFile IOException: " + e.getMessage());
                handler.post(() -> {
    ...
    public void createFile() {
        ...
        pcmFile = new File(FileUtils.INSTANCE.getTempPath(), "audio_record_temp.pcm");
        if (pcmFile.exists()) {
            pcmFile.delete();
        } else {
